...
public enum ExternalProductTypeSourceEnum {
	...
	/**
	 * Issued by the members of the Association of National Numbering Agencies (ANNA), the Classification of Financial Instrument (CFI) code is used to define and describe financial instruments as a uniform set of codes for all market participants.
	 */
	CFI,

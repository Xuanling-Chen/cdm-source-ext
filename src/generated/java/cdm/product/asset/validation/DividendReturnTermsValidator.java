	...
	public ValidationResult<DividendReturnTerms> validate(RosettaPath path, DividendReturnTerms o) {
		String error = 
			Lists.<ComparisonResult>newArrayList(
				...
				checkCardinality("nonCashDividendTreatment", o.getNonCashDividendTreatment()!=null ? 1 : 0, 0, 1),
				checkCardinality("dividendComposition", o.getDividendComposition()!=null ? 1 : 0, 0, 1),
				checkCardinality("specialDividends", o.getSpecialDividends()!=null ? 1 : 0, 0, 1)
